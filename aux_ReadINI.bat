:: ----------------------
:: https://code.i-harness.com/en/q/2bbbc5
:: ----------------------
...
echo;
echo Para ler o valor "terminal":
echo    %~nx0 /s Config /i terminal C:\TERMINAL\mpvenda.ini
echo;
echo Para alterar o valor "usertries" para 5:
echo    %~nx0 /s Config /i usertries /v 5 C:\TERMINAL\mpvenda.ini
echo;
echo Nos exemplos acima, "/s Config" é opcional, mas permitirá a seleção de
echo um item específico em que o arquivo ini contém itens semelhantes em várias seções.
goto :EOF
